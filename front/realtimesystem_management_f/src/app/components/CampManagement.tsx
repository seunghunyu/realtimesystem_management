                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="active">수행 중</SelectItem>
                      <SelectItem value="inactive">수행 완료</SelectItem>
                      <SelectItem value="pending">수행 대기중</SelectItem>
                      <SelectItem value="reg">설계</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
